        ...
        <div class="form-horizontal">
            <div class="form-group">
                <div class="col-sm-12 col-md-7">
                    <div class="row">
                        <p class="caption-subject font-purple-soft bold uppercase margin-bottom-10 margin-left-15">Service Details</p>
                    </div>
                    <!-- Service Provider  -->
                    <div class="row">
                        <div class="col-sm-12">
                            <label for="service_provider_id">Service Provider: <small>if not listed go to the Service Provider tab
                                    in left
                                    sidebar to create new</small></label>
                        </div>
                        <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <label for="wait">Wait Time: <small>eg. 2 weeks for an appointment or 20 min. wait for a phone
                                    service</small></label>
                        </div>
                        <div class="col-sm-12">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <label for="description">Description: <small>incl. info on how to proceed, what to expect and what to
                                    prepare ahead
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <label for="notes">Notes: <small>incl. info about your service for other admins to know (Clients won't
                                    receive/see
                ...
                <div class="col-sm-7">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <p class="caption-subject font-purple-soft bold uppercase margin-bottom-10 margin-top-10">Contact
                                Details</p>
                        </div>
                        <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <label for="phone">Phone Number: <small>eg. 0444 333 222 The number is for clients to contact the
                                    service. If none
                                    put #</small></label>
                        </div>
                        <div class="col-sm-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <p><small>If the service has a catchment add the local government areas or suburbs here. If no catchment
                                    leave
                                    blank</small></p>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="button" class="btn green margin-top-15" @click="save_general_settings()">Save General
                                Settings</button>
                        </div>
                    </div>
                    <!-- End: Save Section  -->

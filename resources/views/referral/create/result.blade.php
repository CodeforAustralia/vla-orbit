                  ...
                  <form autocomplete="off">
                    ...
                    <div class="form-group margin-bottom-10 map-box collapse">
                      ...
                      <div class="col-xs-3 padding-0 margin-bottom-10">
                        <button onclick="getAddress()" class="form-control padding-0 btn grey" type="button">Search</button>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="tel" class="form-control" id="Phone" placeholder="Client mobile number" onkeypress="return isNumberKey(event)" onpaste="return clearString(event)">

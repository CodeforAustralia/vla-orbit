...
<body>
    ...
    <div class="banner">
        ...
        <div class="sq-overlay">
            <div class="col-sm-8 info text-center">
                <h1>Improving legal referrals</h1>
                <h2> Your free new online tool to help clients get to legal services in Victoria</h2>
    ...
    <div class="how_it_works text-center" id="how_it_works">
        ...
        <div class="row">
            ...
            <div class="col-xs-10 col-xs-offset-1 col-sm-5 col-sm-offset-0">
                ...
                <p>Based on clients' circumstances, type of legal matter(s), what stage the legal matter is in and where they live, this tool makes it easy for staff to find accurate referral options.</p>
        ...
        <div class="row">
            ...
            <div class="col-xs-10 col-xs-offset-1 col-sm-5 col-sm-offset-1">
                ...
                <p>Administer your bookable services and allow staff to easily find the next available appointment and book clients directly.</p>
                <p>If appropriate open up bookings to other offices and let them book clients into appointments directly. ​</p>
                <p>With bookings, you have the option to send clients automatic SMS reminders to attend appointments. </p>
            </div>
            <div class="col-xs-10 col-xs-offset-1 col-sm-5 col-sm-offset-0">
        ...
        <div class="row">
            ...
            <div class="col-xs-10 col-xs-offset-1 col-sm-5 col-sm-offset-0">
                ...
                <p>The tool provides over 100 email templates. The emails cover basic information and have been developed by VLA’s Legal Help and Community Legal Education teams.</p>
    ...
    <div class="row col-sm-12 quote text-center" id="quotes">
        ...
        <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2">
            ...
            <p>"Our staff and volunteers use this tool daily to help with referrals. We have a large number of volunteers who appreciate how easy to use and intuitive interface, which is a testament to its human centred design. It helps us to save time and provide better referrals to clients."</p>
        </div>
        <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2">
    ...
    <div class="row logos" id="logos">
        <div class="col-xs-10 col-xs-offset-1">
            <div class="col-xs-12">
                <p>This tool is the product of a thorough research phase learning about client and staff needs. The development has been in close collaboration with frontline staff at Victoria Legal Aid offices and community legal centres.</p>
    ...
    <div class="row contact" id="contact">
        <div class="sq-overlay">
            <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 contact-form">
                ...
                <p>To get access or schedule a demo, please fill in your contact details</p>

    ...
    var handleDemo1 = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "../demo/table_ajax_referral.php", // ajax source
                },
                "ordering": false,
                "order": [
                    [1, "asc"]
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "bStateSave": true, 
                 ...
                 // save custom filters to the state
                "fnStateSaveParams":    function ( oSettings, sValue ) {
                    $("#datatable_ajax_booking tr.filter .form-control").each(function() {
                        sValue[$(this).attr('name')] = $(this).val();
                    });
                ...
                "ajax": {
                    "url": "../demo/table_ajax_booking.php", // ajax source
                },
                "order": [
                    [1, "asc"]
                ],// set first column as a default sort by asc,
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "bStateSave": true, 
                 ...
                 // save custom filters to the state
                "fnStateSaveParams":    function ( oSettings, sValue ) {
                    $("#datatable_ajax_services tr.filter .form-control").each(function() {
                        sValue[$(this).attr('name')] = $(this).val();
                    });
                ...
                "ajax": {
                    "url": "../demo/table_ajax_services.php", // ajax source
                },
                "order": [
                    [1, "asc"]
                ],// set first column as a default sort by asc,

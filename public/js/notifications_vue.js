...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    methods: {
        onNotificationsSeen: function onNotificationsSeen(e) {
            var self = this;
            self.clearNotificationsPromise().then(function (services) {}).catch(function (err) {
                console.log(err);
            });
        },
        clearNotificationsPromise: function clearNotificationsPromise() {
        ...
        checkUrlParams: function checkUrlParams() {
            ...
            if (self.getUrlParameter('dashboard')) {
                var message_el = document.getElementById(self.getUrlParameter('dashboard'));
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(20), __webpack_require__(60).setImmediate))

...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vuejs_datatable_dist_vuejs_datatable_esm_js__ = __webpack_require__(158);
...
__WEBPACK_IMPORTED_MODULE_3_vuejs_datatable_dist_vuejs_datatable_esm_js__["a" /* default */].useDefaultType(false).registerTableType('datatable', function (table_type) {
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_3_vuejs_datatable_dist_vuejs_datatable_esm_js__["a" /* default */]);

__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('actionBtns', {
    ...
    methods: {
        ...
        isFutureBooking: function isFutureBooking() {
            var today = __WEBPACK_IMPORTED_MODULE_2_moment___default()().format('YYYY-MM-DD');
            var appt_date = __WEBPACK_IMPORTED_MODULE_2_moment___default()(this.row.date).format('YYYY-MM-DD');
            var is_after = __WEBPACK_IMPORTED_MODULE_2_moment___default()(appt_date).isAfter(today);
            return is_after;
        },
        sendReminder: function sendReminder() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(url, {
                ...
                if (self.row.sms_date) {
                    self.row.sms_date += ', ' + __WEBPACK_IMPORTED_MODULE_2_moment___default()().format('YYYY-MM-DD');
                } else {
                    self.row.sms_date = __WEBPACK_IMPORTED_MODULE_2_moment___default()().format('YYYY-MM-DD');
                }
                alert('Message sent.');
        ...
        deleteBooking: function deleteBooking() {
            var self = this;
            var confirmation = confirm("Are you sure that you want to delete it?\n To confirm press OK or Cancel.");
            if (confirmation == true) {
                $("#contentLoading").modal("show");
                var url = '/booking/' + self.row.id;
...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    data: {
        filter: '',
        columns: [{ label: 'id', field: 'id' }, { label: 'Date', field: 'date', headerClass: 'class-in-header second-class' }, { label: 'Time', field: 'time' }, { label: 'Service', field: 'ServiceName' }, { label: 'Service Provider', field: 'ServiceProviderName' }, { label: 'First Name', field: 'client.first_name' }, { label: 'last Name', field: 'client.last_name' }, { label: 'Phone', field: 'client.contact' }, { label: 'Sent SMS', field: 'sms_date' }, {
            label: '',
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_object_path__ = __webpack_require__(159);

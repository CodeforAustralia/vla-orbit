...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    data: {
        filter: '',
        columns: [{ label: 'id', field: 'id' }, { label: 'Date', field: 'date', headerClass: 'class-in-header second-class' }, { label: 'Time', field: 'time' }, { label: 'Service', field: 'ServiceName' }, { label: 'First Name', field: 'client.first_name' }, { label: 'last Name', field: 'client.last_name' }, { label: 'Phone', field: 'client.contact' }, { label: 'Sent SMS', field: 'sms_date' }, {
            label: '',
